...
public class dragndrop1 : MonoBehaviour,IBeginDragHandler,IDragHandler,IEndDragHandler{
	private static int slots = 3;//always one more
	private static int numOfCommands =2;
