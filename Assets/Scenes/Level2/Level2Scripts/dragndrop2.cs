...
public class dragndrop2 : MonoBehaviour,IBeginDragHandler,IDragHandler,IEndDragHandler{
	private static int slots = 4;//always one more
	private static int numOfCommands =4;
