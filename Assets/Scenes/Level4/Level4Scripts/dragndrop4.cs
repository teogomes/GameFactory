...
public class dragndrop4 : MonoBehaviour,IBeginDragHandler,IDragHandler,IEndDragHandler{
	private static int slots = 7;//always one more
	private static int numOfCommands =7;
